<?php $this->define('github-icon') ?>
<svg class="icon" width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
...
<a class="suggest-edit" href="https://github.com/getformwork/getformwork-site/blob/main<?= Formwork\Utils\Str::removeStart($page->path(), $site->path()) ?><?= $page->template() ?>.md"><?= $this->block('github-icon') ?> Suggest an edit on GitHub</a>